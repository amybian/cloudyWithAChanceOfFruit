...
let score = 0;
let backgroundImage,basket,apple,pear,banana,orange,rand,start,fruitBasket, heart1, heart2, heart3, heart, emptyHeart;
let started = false;
let lives = 3;
...
//resize images
  ...
  fallingObject = new Sprite(pear,100,0,10);
...
function newFruit(){
  ...
  if(rand <1){
    ...
    fallingObject.image = pear;
  } else if (rand <= 3){
    fallingObject.image = orange;
  } else if (rand <= 4){
